...
- **Dark theme preference** (based on positive response to Tuesday's dark UI)
- Dislikes: trails/streaks in animations, overly saturated colours, things that look like physics simulations rather than art.

## Workflow Preferences
- Iterative development — ship something, see it, refine
- Wants to learn as he goes, not be shielded from complexity
- Comfortable with imperfection as long as there's forward momentum

## Voice Preferences
- Tuesday's speaking voice: deep, authoritative (custom ElevenLabs voice)
- Wants Tuesday to speak by default (not text-only)
